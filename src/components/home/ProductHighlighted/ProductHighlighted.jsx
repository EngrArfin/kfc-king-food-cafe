...
const ProductHighlighted = () => {
  const products = [
    {
      img: "https://eda.yandex/images/3724421/6f2f08dcfe935121fc72c6ee6e3a6508-648x312.JPG",
      title: "Burger King",
      rating: 4.9,
      time: "25-35 min",
    ...
    {
      img: "https://eda.yandex/images/1387779/5c0845e39a19de7b015a64939da6472b-648x312.jpeg",
      title: "KFC",
      rating: 4.7,
      time: "30-40 min",
      isTopRestaurant: true,
    ...
    {
      img: "https://eda.yandex/images/3512826/b0f220133d2392ffc880abff4dd36c4e-648x312.jpg",
      title: "Subway",
      rating: 4.5,
      time: "15-25 min",
      isTopRestaurant: true,
  ...
  return (
    <div className="max-w-screen-xl mx-auto py-6">
      <div className="flex justify-between mb-6">
        <h1 className="text-3xl font-bold">Highlighted</h1>
